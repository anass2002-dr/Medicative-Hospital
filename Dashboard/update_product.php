              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Update produtc Using html code
                  </p>
                  <?php
                    if (isset($_GET["id"])) {
                        $id = $_GET["id"];
                      ...
                      echo "
                                    ...
                                    <label for='photo' class='form-label'>size 10 x 10 cm</label>
                                    ...
                                    <textarea name='product' id='product' class='form-control'rows='50'>$product</textarea>                   
                                    </div>

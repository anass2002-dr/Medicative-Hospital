                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post" action="insertProduct.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sponsor_name" placeholder="SPONSOR NAME" name="sponsor_name" require>
                                        </div>
                                        <div class="form-group">
                                            <label for="sponsor_url">Sponsor url</label>
                                            <input type="text" class="form-control" id="sponsor_url" placeholder="SPONSOR URL" name="sponsor_url" require>
                                        </div>
                                        <div class="mb-3">

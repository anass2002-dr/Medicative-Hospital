                      ...
                      if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>
                                ...
                                <td>$CATEGORY_NAME</td>
                                <td>$CREATED_DATE</td>
                                <td><a href='update_product.php?id=$PRODUCT_ID' class='update btn text-light' style='background-color:#00e7a1;' id='update_<?= $PRODUCT_ID ?>' data-id='$PRODUCT_ID' >update</A>
                                </td>

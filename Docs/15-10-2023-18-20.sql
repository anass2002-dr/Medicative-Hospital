...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2023 at 06:36 PM
...
--
CREATE DATABASE IF NOT EXISTS `beautymedic` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `beautymedic`;
...
(9, 'beurer', 'www.beurer.com', NULL),
(10, 'alixpress', 'www.alixpress.com', NULL);
...
--
ALTER TABLE `product_collection_photos`
  MODIFY `PD_COLLECTION_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `sponsor`
--
ALTER TABLE `sponsor`
  MODIFY `SPONSOR_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

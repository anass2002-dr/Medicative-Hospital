...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 19 oct. 2023 à 18:48
...
(14, 'Sephora', 'https://www.sephora.com/', '1697391724.png', NULL, NULL),
...
--
ALTER TABLE `product_collection_photos`
  MODIFY `PD_COLLECTION_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
